...
namespace DLLInjection.InjectionStrategies
{
	...
	{
		// Token: 0x0600004E RID: 78 RVA: 0x00004A14 File Offset: 0x00002A14
		protected override IntPtr Inject(IntPtr processHandle, IntPtr loadLibraryAddress, IntPtr addressOfDllPath)
		{
		}

		// Token: 0x0600004F RID: 79 RVA: 0x00004B6E File Offset: 0x00002B6E
		public NtCreateThreadExInjectionStrategy()
		{
			/*
An exception occurred when decompiling this method (0600004F)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void DLLInjection.InjectionStrategies.NtCreateThreadExInjectionStrategy::.ctor()
